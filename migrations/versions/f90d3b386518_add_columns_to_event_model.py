...
def upgrade():
    ...
    op.add_column('events', sa.Column('latitude', sa.Numeric(precision=16, scale=12), nullable=True))
    op.add_column('events', sa.Column('longitude', sa.Numeric(precision=16, scale=12), nullable=True))
    ...
    op.add_column('events', sa.Column('price', sa.Numeric(precision=8, scale=8), nullable=True))
