...
def upgrade():
    ...
    op.add_column('events', sa.Column('latitude', sa.Numeric(precision=16, scale=16), nullable=True))
    op.add_column('events', sa.Column('longitude', sa.Numeric(precision=16, scale=16), nullable=True))
